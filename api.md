...
4) Как только возвращается `"status" : "done"`, получает json через `/downloadarchive`, декодирует base64 представления и сохраняет.
...
4) Скачивание архива по номеру запроса.
...
4) Скачивание архива уменьшенных фотографий по номеру запроса.
